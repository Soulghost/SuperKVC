#
#  Be sure to run `pod spec lint SuperKVC.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "SuperKVC"
  s.version      = "0.0.1"
  s.summary      = "Cocoa Model Framework with a simplified, chainable and expressive syntax."
  ...
  s.description  = "Cocoa Model Framework with a simplified, chainable and expressive syntax."
  #                 DESC
